      ...
      var rng = range.create();
			var html =
				'<ul class="nav nav-tabs" id="myTab">' +
					'<li class="active"><a data-toggle="tab" href="#sm-tab-' + uid + '1">Home</a></li>' +
					'<li><a data-toggle="tab" href="#sm-tab-' + uid + '2">Profile</a></li>' +
					'<li class="dropdown">' +
						...
						'<ul aria-labelledby="myTabDrop1" role="menu" class="dropdown-menu">' +
							'<li><a data-toggle="tab" tabindex="-1" href="#sm-tab-' + uid + '3">@fat</a></li>' +
							'<li><a data-toggle="tab" tabindex="-1" href="#sm-tab-' + uid + '4">@mdo</a></li>' +
						'</ul>' +
					'</li>' +
				'</ul>' +
				...
				'<div class="accordion">' +
					'<div class="accordion-group">' +
						'<div class="accordion-heading">' +
							'<h3 class="accordion-toggle" data-toggle="collapse" data-parent="#accordion2" href="#sm-collapse-' + uid + '">' +
								'Collapsible Group Item #1' +
							'</h3>' +
						'</div>' +
					'<div id="sm-collapse-' + uid + '" class="accordion-body collapse in">' +
