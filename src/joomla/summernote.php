 ...
 */
class plgEditorSummernote extends JPlugin
{
	/**
	 * Constructor
	 *
	...
	public function onSave($editor)
	{
		ob_start();
		?>
		var who = SMEditor.code();
		document.getElementById( '<?php echo $editor;?>' ).value 	= who;
		<?php
	...
	public function onDisplay($name, $content, $width, $height, $col, $row, $buttons = true, $id = null, $asset = null, $author = null)
	{
		...
		<script type="text/javascript">
			function iframeLoaded(summernote) {
				SMEditor = summernote;
				var textarea 	= jQuery('#jform_articletext');

				var html = jQuery('<div/>').html(textarea.html()).text();
				SMEditor.code(html);
				textarea.hide() ;
			}
		</script>
		...
		<iframe width="100%" height="500" src="/plugins/editors/summernote/iframe.html" frameborder="0" > </iframe>
